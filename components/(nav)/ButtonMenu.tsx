...
export default function ButtonMenu() {
  ...
  return (
    <nav className={`fixed bottom-0 w-full flex justify-around border-none bg-light-yellow-100 shadow-md ${pathname === '/scan' ? "border-white" : "border-red-500" } overflow-hidden md:max-w-[60%] lg:max-w-[50%] xl:max-w-[40%]`}>
      <Link 
