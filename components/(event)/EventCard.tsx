...
export default function EventCard() {
    return (
        <Link href="/event">
            <Card className="flex justify-between items-center group hover:bg-neutral-200 px-6 py-4 mb-4 lg:p-6 select-none">
                <section className="flex flex-col gap-4">
                    <CardHeader className="space-y-0">
                        <CardTitle className="text-2xl font-bold">Event Title</CardTitle>
                        <CardDescription className="leading-3">by Event Host</CardDescription>
                    </CardHeader>
                    <CardContent className="text-sm leading-3 space-y-1">
